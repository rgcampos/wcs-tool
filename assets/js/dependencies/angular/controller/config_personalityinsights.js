app.controller("configPersonalityInsights", ['$scope', '$timeout', '$http', function ($scope, $timeout, $http) {
    ...
    $scope.load = function () {
        let req = {
            method: 'GET',
            cache: false,
            url: '/configpersonalityinsights/load',
            headers: {
    ...
    $scope.formSubmit = function () {
        ...
        let req = {
            method: 'POST',
            url: '/configpersonalityinsights/save',
            headers: {
                'Content-Type': 'application/json'
            },
            data: dataParams
